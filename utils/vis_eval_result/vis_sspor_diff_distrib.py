...
# 20.8
data = json.load(open("/mnt/nvme0n1p1/hongxin_li/AutoGUI/logs/uipro/1112_100835_test_uipro_func_pred_rec-motif-refexp-screenspot_rec-vwb/screenspot_rec_test.json"))
